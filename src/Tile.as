package  
{
	public class Tile 
	{
		public static var grass:Tile = new Tile(false, false, 0.1);
		public static var grass_fire:Tile = new Tile(false, false);
		public static var tree:Tile = new Tile(true, true, 0.25);
		...
		public static var door_closed:Tile = new Tile(false, true, 0.25);
		public static var door_opened:Tile = new Tile(false, false, 0.25);
		...
		static public var burnt_ground:Tile = new Tile(false, false);
		...
		public function Tile(blocksMovement:Boolean, blocksArrows:Boolean, burnChance:Number = 0.0) 
		{
